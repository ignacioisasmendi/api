...
import { TikTokPrivacyLevel, TikTokSourceType, TIKTOK_MAX_FILE_SIZE_BYTES } from '../../tiktok.constants';
...
export class InitDirectPostDto {
  ...
  @IsNotEmpty({ message: 'video_url is required when source_type is PULL_FROM_URL' })
  video_url?: string;
  ...
  @IsNotEmpty({ message: 'video_size is required when source_type is FILE_UPLOAD' })
  video_size?: number;
